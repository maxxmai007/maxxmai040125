    ...
    <div className={cn(
      ...
      <div className="relative w-full">
        <input
          ...
          min={1000}
          max={1000000} // Updated to 10 lakhs
          step={1000}
          className={cn(
          ...
          style={{
            background: `linear-gradient(to right, #D4B788 0%, #D4B788 ${(value - 1000) / 9990}%, rgba(212, 183, 136, 0.1) ${(value - 1000) / 9990}%, rgba(212, 183, 136, 0.1) 100%)`
          }}
        />
      </div>
